...
az storage account create -n mdtest4321 -g DataAcademy2023

# create storage account in the uksouth region
az storage account create -n mdtest4321 -g DataAcademy2023 -l uksouth

# same as the above with the full parameters names
az storage account create --name mdtest4321 --resource-group DataAcademy2023 --location uksouth

# list all accounts
az storage account list -g DataAcademy2023 -o table
...
az storage account delete -g DataAcademy2023 -n mdtest4321

# show the connection string to the account
az storage account show-connection-string -n mdtest4321 -g DataAcademy2023
az storage account show-connection-string --query connectionString -n mdtest4321 -g DataAcademy2023
az storage account show-connection-string --query connectionString --name mdtest4321 --resource-group DataAcademy2023
